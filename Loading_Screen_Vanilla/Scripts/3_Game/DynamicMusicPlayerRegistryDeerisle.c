class DynamicMusicPlayerRegistryDeerisle : DynamicMusicPlayerRegistry
{
	...
	override protected void RegisterTracksLocationStatic()
	{
		...
		//RegisterTrackLocationStaticMultiRectangle("Music_loc_city_day_1_SoundSet", cityGraveyard, DynamicMusicPlayerTimeOfDay.DAY);
		//RegisterTrackLocationStaticMultiRectangle("Music_loc_city_day_2_SoundSet", cityGraveyard, DynamicMusicPlayerTimeOfDay.DAY);
		RegisterTrackLocationStaticMultiRectangle("YourPBOName_Music_3_SoundSet", cityGraveyard, DynamicMusicPlayerTimeOfDay.NIGHT);
		//RegisterTrackLocationStaticMultiRectangle("Music_loc_city_night_1_SoundSet", cityGraveyard, DynamicMusicPlayerTimeOfDay.NIGHT);
		//RegisterTrackLocationStaticMultiRectangle("Music_loc_city_night_2_SoundSet", cityGraveyard, DynamicMusicPlayerTimeOfDay.NIGHT);
