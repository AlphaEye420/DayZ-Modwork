class CraftCodelockexp extends RecipeBase	 // Must Change Name
{	
	override void Init()
	{
		m_Name = "Craft Expansion Code Lock";  // Must Change Name
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CodeLock"); // Must Change Name
		...
		//result1
		AddResult("ExpansionCodeLock");//add results here
