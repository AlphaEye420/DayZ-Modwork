class CraftGoldbar extends RecipeBase	 // Must Change Name
{	
	override void Init()
	{
		m_Name = "Craft Gold Bar";  // Must Change Name
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ExpansionGoldNugget"); // Must Change Name
		...
		//result1
		AddResult("ExpansionGoldBar");//add results here
