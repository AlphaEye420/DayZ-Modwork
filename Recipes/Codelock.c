class CraftCodelock extends RecipeBase	 // Must Change Name
{	
	override void Init()
	{
		m_Name = "Craft Regular Code Lock";  // Must Change Name
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ExpansionCodeLock"); // Must Change Name
		...
		//result1
		AddResult("CodeLock");//add results here
