class CraftSilverbar extends RecipeBase	 // Must Change Name
{	
	override void Init()
	{
		m_Name = "Craft Silver Bar";  // Must Change Name
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ExpansionSilverNugget"); // Must Change Name
		...
		//result1
		AddResult("ExpansionSilverBar");//add results here
