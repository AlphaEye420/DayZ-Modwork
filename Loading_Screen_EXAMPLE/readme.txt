...
2. Open 3 code files provided in this folder in an editor 
3. Put all of your edds pictures files and ogg music file in the folder called 'data'
4. In the 2 .c files and config.cpp, change the text of YourModName to the name of your mod on steam !! DO this in ALL 3 files mentioned above !!
